...
Download [com.alcyone.vpn_3.0.9_all.ipk](https://raw.githubusercontent.com/ichikanya/Alcyone/main/packages/com.alcyone.vpn_3.0.9_all.ipk) and install it with webOS Dev Manager, `ares-install`, or the Homebrew Channel installation service.

## Notes

- After turning on the TV, wait until the network connection is established before starting the VPN.
- VPN shutdown can be unstable on some webOS versions. Restarting Alcyone usually restores the expected state.
